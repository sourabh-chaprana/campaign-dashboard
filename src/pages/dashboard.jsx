      ...
      <Grid item xs={12} sm={4}>
        <Card>
          <CardContent>
            ...
            <Typography variant="h4" color="textPrimary">45k</Typography>
            <Typography variant="body2" color="textSecondary">▲ 15% This is Card title</Typography>
            <Box mt={2} height={100}>
      ...
      <Grid item xs={12} sm={4}>
        <Card>
          <CardContent>
            ...
            <Typography variant="h4" color="textPrimary">22</Typography>
            <Typography variant="body2" color="textSecondary">▲ 15% This is Card title</Typography>
            <Box mt={2} height={100}>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
      ...
      <Grid item xs={12} sm={4}>
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="textSecondary">▲ 12% This is Card title</Typography>
            <Box mt={2} height={100}>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" />
